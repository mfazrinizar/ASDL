...
import com.mfazrinizar.asdl.ADT.Linear.LinkedList.Singly.LinkedListWithTail;

public class LinkedListSinglyWithTailDriver {
    public static void main(String[] args) {
        LinkedListWithTail linkedList = new LinkedListWithTail();
        ...
        linkedList.deleteAfter(linkedList.head);
        linkedList.printList();
        System.out.println();
